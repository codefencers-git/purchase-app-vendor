...
class AppSharedPreference {
  ...
  static Future<void> setJwtId(String jwtToken) async => _getStorage.write(_jwtId, jwtToken);

  static String? get jwtId => _getStorage.read(_jwtId);
