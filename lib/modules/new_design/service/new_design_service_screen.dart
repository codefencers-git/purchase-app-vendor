...
//         'CF-Token': '{{CF-Token}}',
//         'Authorization':
//             'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MywiaWF0IjoxNjc2ODgzNzE3LCJleHAiOjE2NzY5NzAxMTd9._U37nSWCSCkVnNZhuDGVwGSB8jQrLBMsOKPqTPx5L0s'
//       };
//       var request = http.MultipartRequest('POST', Uri.parse('https://api.gartext.com/api/vendor/save-design'));
//       request.fields.addAll({
//         'vendor_id': '3',
...
//           'image', '/data/user/0/com.purchase_vendor/cache/file_picker/IMG-20230220-WA0001.jpg'));
//       request.files.add(await http.MultipartFile.fromPath(
//           'image_variation_list', '/data/user/0/com.purchase_vendor/cache/file_picker/IMG-20230220-WA0001.jpg'));
//       request.headers.addAll(headers);
//
//       http.StreamedResponse response = await request.send();
//
